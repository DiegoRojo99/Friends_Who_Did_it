...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        answer0.setOnClickListener(view -> answerSelected=0);
        answer1.setOnClickListener(view -> answerSelected=1);
        answer2.setOnClickListener(view -> answerSelected=2);
        answer3.setOnClickListener(view -> answerSelected=3);
